...
public class WitchdoctorGuiController
{
     ...
     */
    public WitchdoctorGuiController(@NotNull final Inventory gui, @NotNull final HumanEntity player, @NotNull final WitchdoctorGuiManager manager, final boolean admin)
    {
        this.player = player;
        this.gui = gui;
